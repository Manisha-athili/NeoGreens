...
export default function SimpleSection() {
  return (
    <section className="relative py-12 bg-[light-cream] h-full w-full min-h-[600px]">
      <div className="container mx-auto px-4 h-full">
        <div className="relative w-full h-full flex flex-col lg:block">
          ...
          <div className="w-full lg:w-1/2 lg:absolute lg:top-0 lg:left-25 lg:transform bg-primary-teal text-cream p-8 lg:pl-6 lg:py-14 rounded-l-xl lg:rounded-r-none shadow-md
            ...
            <div className=" p-10 flex flex-col justify-center">
              <h2 className="text-2xl sm:text-3xl lg:text-5xl font-serif mb-6">
                The Simple Solution to Modern Lifestyle Health Issues
              </h2>
              <p className="text-base sm:text-lg lg:text-lg mb-8">
          ...
          <div className="w-full lg:w-1/2 lg:absolute lg:top-0 lg:right-25 lg:transform z-10 mt-8 lg:mt-0">
                ...
                <img
                  ...
                  className="hidden md:block w-full h-full object-cover rounded-r-xl lg:rounded-l-none shadow-md"
                  loading="lazy"
                />
                ...
                <img
                  ...
                  className="block md:hidden w-full h-full object-cover rounded-xl shadow-md"
                  loading="lazy"
                />
